...
public class VulkanException : Exception {
	...
	public VulkanException(Reason reason) : base(ReasonToString(reason)) => ReasonValue = reason;
	public VulkanException(Reason reason, VkResult result, params object?[] args) : base(string.Format(ReasonToString(reason), result, args)) => ReasonValue = reason;
