...
namespace USharpLibs.Engine.Client.GL {
	...
	public class DefaultHudShader : ExampleShader {
		...
		private void UncheckedSetProjection(Matrix4 projection) => OpenGL4.UniformMatrix4(UniformLocations["Projection"], true, ref projection); // Ugly fix. because OpenGL4#UniformMatrix4 uses 'ref'
	}
}