...
using Engine3.Client.Client.Graphics.OpenGL.Objects;
using Engine3.Client.Client.ImGui;
using ImGuiNET;
using OpenTK.Graphics.OpenGL;
using ImGuiNet = ImGuiNET.ImGui;

namespace Engine3.Client.Client.Graphics.OpenGL.Renderers;
...
public unsafe class OpenGLImGuiRenderer : ImGuiRenderer {
	...
	private static void CreatePipeline(OpenGLResourceProvider graphicsResourceProvider, out OpenGLShader vertexShader, out OpenGLShader fragmentShader, out ProgramPipeline programPipeline) {
		vertexShader = graphicsResourceProvider.CreateShader($"{ImGuiAssetName} Vertex Shader", ImGuiAssetName, ShaderType.Vertex, Core.Engine3.Engine.Assembly);
		fragmentShader = graphicsResourceProvider.CreateShader($"{ImGuiAssetName} Fragment Shader", ImGuiAssetName, ShaderType.Fragment, Core.Engine3.Engine.Assembly);
