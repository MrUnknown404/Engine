...
public abstract class OpenGLRendererBase : WindowRenderer {
	private static readonly Logger Logger = LogManager.GetCurrentClassLogger();

	public sealed override OpenGLWindow Window { get; }
	...
	protected OpenGLRendererBase(OpenGLBackend backend, OpenGLWindow window) : base(_3DGraphicsApi.OpenGL) {
		Window = window;
		...
		GL.ClearColor(Window.ClearColor.ToOpenTKColor4());
