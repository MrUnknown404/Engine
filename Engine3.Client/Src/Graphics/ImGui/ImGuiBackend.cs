...
public unsafe class ImGuiBackend {
	...
	// public IImGuiProvider? DebugUIImGui { get; set; } // TODO re-add
	...
	public ImGuiBackend(Window window, _3DGraphicsApi graphicsBackend, Action? showImGui = null) {
		...
		io.NativePtr->BackendRendererName = (byte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference(Encoding.UTF8.GetBytes($"{Core.Engine3.Name.ToLower()}_impl_{graphicsBackend.ToString().ToLower()}")));
