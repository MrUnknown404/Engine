...
public class VulkanRenderer : Renderer {
	public VulkanRenderer(RenderTarget renderTarget, VulkanGraphicsProvider graphicsProvider, params RenderPass[] renderPasses) : base(GraphicsApi.Vulkan, renderTarget, graphicsProvider, renderPasses) { }
