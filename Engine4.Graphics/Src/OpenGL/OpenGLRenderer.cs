...
public class OpenGLRenderer : Renderer {
	public OpenGLRenderer(RenderTarget renderTarget, IGraphicsApiProvider graphicsProvider, params RenderPass[] renderPasses) : base(GraphicsApi.OpenGL, renderTarget, graphicsProvider, renderPasses) { }
